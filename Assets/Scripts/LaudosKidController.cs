...
public class LaudosKidController : MonoBehaviour
{
    ...
    public Dialogue CatharinAndLaudosKidsDialogue1;
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.F))
        {
            if (Vector2.Distance(Player.transform.position, self.transform.position) < interactionDistance && canInteract)
            {
                ...
                {
                    dialogueController.StartDialogue(CatharinAndLaudosKidsDialogue1);
                }
